...
import socket
import numpy as np
## This file does not contain load arm and should not be altered as it is the reference every new load cell file will be based off.
# Functions
def value_to_grams(value): # Convert raw sensor value to grams
    return 0.00464334*float(value)
